      ...
      >
        ...
        >
          <div className="flex-row h-full max-w-96 p-2">
            ...
            <Button
              onClick={() => setPage(1)}
              className={`font-[OpenSans] bg-transparent mb-2 justify-start text-black w-full border-2 border-transparent hover:bg-pink-200 ${
                page == 1 ? "bg-pink-200" : "bg-transparent"
              }`}
            >
            ...
            {usuario.micompany !== null && <Button
              onClick={() => setPage(2)}
              className={`font-[OpenSans] bg-transparent mb-2 justify-start text-black w-full border-2 border-transparent hover:bg-pink-200 ${
                page == 2 ? "bg-pink-200" : "bg-transparent"
              }`}
            >
              {(sizePanel > 18 || sizePanel < 14) &&
                (sizePanel < 14 ? (
            ...
            <Button
              onClick={() => setPage(3)}
              className={`font-[OpenSans] bg-transparent mb-2 justify-start text-black w-full border-2 border-transparent hover:bg-pink-200 ${
                page == 3 ? "bg-pink-200" : "bg-transparent"
              }`}
            >
              {(sizePanel > 18 || sizePanel < 14) &&
                (sizePanel < 14 ? (
